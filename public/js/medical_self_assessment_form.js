document.getElementById('medicalSelfAssessmentForm').addEventListener('submit', async function(e) {
    e.preventDefault();
    ...
    try {
        ...
        if (data.redirect) {
            Swal.fire({
                icon: 'success',
                title: 'Success!',
                text: data.message || 'Medical self-assessment submitted successfully.',
