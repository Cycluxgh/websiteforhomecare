    ...
    <section
        ...
        <div class="container relative">
            <div class="grid grid-cols-1 pb-8 text-center mt-12">
                ...
                <ul class="list-none">
                    <li class="inline text-slate-400 me-3">{{ __('All applicants must be 18 years and above') }}</span>
                    </li>
                </ul>
            </div><!--end grid-->
        </div><!--end container-->
                        ...
                        <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid lg:grid-cols-12 gap-6">
                                ...
                                <div class="lg:col-span-6">
                                    <label for="typejob" class="font-semibold">Job Title:</label>
                                    <select name="job_posting_id" id="typejob"
