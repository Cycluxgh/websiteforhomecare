<x-frontend-layout>
    ...
    <section class="md:h-screen py-36 h-auto relative flex items-center background-effect overflow-hidden bg-[url('../../assets/images/job/job.jpg')] bg-cover">
                            ...
                            <form action="#">
                                <div class="registration-form relative text-slate-900 text-start">
                                    <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6 lg:divide-x-[1px] lg:divide-gray-200 lg:dark:divide-gray-700">
                                        ...
                                        <input type="submit" id="search" name="search" style="height: 60px;" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-blue-600 hover:bg-blue-700 border-blue-600 hover:border-blue-700 text-white searchbtn lg:rounded-t-none lg:rounded-e-sm lg:rounded-b-sm lg:rounded-s-none rounded-lg w-full" value="Search">
                                    </div><!--end grid-->
                                </div><!--end container-->
                            </form>
                        </div>
        ...
        <ul class="circles absolute inset-0 h-full w-full overflow-hidden p-0 mb-0">
            <li class="brand-img"><img src="frontend/assets/images/client/shree-logo.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/skype.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/snapchat.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/spotify.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/telegram.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/whatsapp.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/android.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/facebook-logo-2019.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/linkedin.png" class="size-9" alt=""></li>
            <li class="brand-img"><img src="frontend/assets/images/client/google-logo.png" class="size-9" alt=""></li>
        </ul>
    </section>
            ...
            <div class="grid grid-cols-1 relative">
                <div class="tiny-five-item">
                    <div class="tiny-slide">
                        <div class="px-3 py-10 rounded-md shadow-sm dark:shadow-gray-800 group text-center bg-white dark:bg-slate-900 hover:bg-blue-600/5 dark:hover:bg-blue-600/5 duration-500 m-2">
                            <div class="size-[84px] bg-blue-600/5 group-hover:bg-blue-600 text-indigo-600 group-hover:text-white rounded-full text-3xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 duration-500 mx-auto">
                                <i class="uil uil-gitlab"></i>
                            </div>

                            <div class="content mt-6">
                                <a href="page-job-grid.html" class="title h5 text-lg font-medium hover:text-indigo-600">Business <br> Development</a>
                    ...
                    <div class="tiny-slide">
                        <div class="px-3 py-10 rounded-md shadow-sm dark:shadow-gray-800 group text-center bg-white dark:bg-slate-900 hover:bg-blue-600/5 dark:hover:bg-blue-600/5 duration-500 m-2">
                            ...
                            <div class="content mt-6">
                                <a href="page-job-grid.html" class="title h5 text-lg font-medium hover:text-indigo-600">Marketing & <br> Communication</a>
                    ...
                    <div class="tiny-slide">
                        <div class="px-3 py-10 rounded-md shadow-sm dark:shadow-gray-800 group text-center bg-white dark:bg-slate-900 hover:bg-blue-600/5 dark:hover:bg-blue-600/5 duration-500 m-2">
                            ...
                            <div class="content mt-6">
                                <a href="page-job-grid.html" class="title h5 text-lg font-medium hover:text-indigo-600">Project <br> Management</a>
                    ...
                    <div class="tiny-slide">
                        <div class="px-3 py-10 rounded-md shadow-sm dark:shadow-gray-800 group text-center bg-white dark:bg-slate-900 hover:bg-blue-600/5 dark:hover:bg-blue-600/5 duration-500 m-2">
                            ...
                            <div class="content mt-6">
                                <a href="page-job-grid.html" class="title h5 text-lg font-medium hover:text-indigo-600">Customer <br> Service</a>
                    ...
                    <div class="tiny-slide">
                        <div class="px-3 py-10 rounded-md shadow-sm dark:shadow-gray-800 group text-center bg-white dark:bg-slate-900 hover:bg-blue-600/5 dark:hover:bg-blue-600/5 duration-500 m-2">
                            ...
                            <div class="content mt-6">
                                <a href="page-job-grid.html" class="title h5 text-lg font-medium hover:text-indigo-600">Software <br> Engineering</a>
                    ...
                    <div class="tiny-slide">
                        <div class="px-3 py-10 rounded-md shadow-sm dark:shadow-gray-800 group text-center bg-white dark:bg-slate-900 hover:bg-blue-600/5 dark:hover:bg-blue-600/5 duration-500 m-2">
                            ...
                            <div class="content mt-6">
                                <a href="page-job-grid.html" class="title h5 text-lg font-medium hover:text-indigo-600">Human <br> Resources</a>
        ...
        <div class="container relative">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div class="grid grid-cols-12 gap-6 items-center">
                        <div class="col-span-6">
                            <div class="grid grid-cols-1 gap-6">
                                <img src="frontend/assets/images/about/ab03.jpg" class="shadow-sm rounded-md" alt="">
                                <img src="frontend/assets/images/about/ab02.jpg" class="shadow-sm rounded-md" alt="">
                            </div>
                        </div>

                        <div class="col-span-6">
                            <div class="grid grid-cols-1 gap-6">
                                <img src="frontend/assets/images/about/ab01.jpg" class="shadow-sm rounded-md" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-7 md:col-span-6">
                    <div class="lg:ms-5">
                        <h3 class="mb-6 md:text-3xl text-2xl lg:leading-normal leading-normal font-medium">We are Largest Job <br> Site in The World</h3>

                        <p class="text-slate-400 max-w-xl mb-2">Launch your campaign and benefit from our expertise on designing and managing conversion centered Tailwind css html page.</p>
                        ...
                        <div class="mt-6">
                            <a href="" class="relative inline-block font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:duration-500 text-indigo-600 hover:text-indigo-600 after:bg-blue-600 duration-500 ease-in-out">Read More <i class="uil uil-arrow-right align-middle"></i></a>
                        </div>
                    </div>
                </div>
            </div><!--end grid-->
        ...
        <div class="container relative mt-12">
            <div class="grid grid-cols-2 md:grid-cols-4">
                <div class="counter-box relative text-center">
                    <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5"><span class="counter-value" data-target="200">3</span>+K</h3>
                    <span class="counter-head font-semibold text-xl absolute top-2/4 start-0 end-0">Total User</span>
                </div><!--end counter box-->

                <div class="counter-box relative text-center">
                    <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5"><span class="counter-value" data-target="15">1</span>+</h3>
                    <span class="counter-head font-semibold text-xl absolute top-2/4 start-0 end-0">Years of Experience</span>
                </div><!--end counter box-->

                <div class="counter-box relative text-center">
                    <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5"><span class="counter-value" data-target="54">5</span></h3>
                    <span class="counter-head font-semibold text-xl absolute top-2/4 start-0 end-0">Offices in the World</span>
                </div><!--end counter box-->

                <div class="counter-box relative text-center">
                    <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5"><span class="counter-value" data-target="125">12</span>K</h3>
                ...
                <div class="tiny-three-item">
                    <div class="tiny-slide text-center">
                        <div class="cursor-e-resize">
                            ...
                            <div class="text-center mt-5">
                                <img src="frontend/assets/images/client/01.jpg" class="size-14 rounded-full shadow-md mx-auto" alt="">
                    ...
                    <div class="tiny-slide text-center">
                        <div class="cursor-e-resize">
                            ...
                            <div class="text-center mt-5">
                                <img src="frontend/assets/images/client/02.jpg" class="size-14 rounded-full shadow-md mx-auto" alt="">
                    ...
                    <div class="tiny-slide text-center">
                        <div class="cursor-e-resize">
                            ...
                            <div class="text-center mt-5">
                                <img src="frontend/assets/images/client/03.jpg" class="size-14 rounded-full shadow-md mx-auto" alt="">
                    ...
                    <div class="tiny-slide text-center">
                        <div class="cursor-e-resize">
                            ...
                            <div class="text-center mt-5">
                                <img src="frontend/assets/images/client/04.jpg" class="size-14 rounded-full shadow-md mx-auto" alt="">
                    ...
                    <div class="tiny-slide text-center">
                        <div class="cursor-e-resize">
                            ...
                            <div class="text-center mt-5">
                                <img src="frontend/assets/images/client/05.jpg" class="size-14 rounded-full shadow-md mx-auto" alt="">
                    ...
                    <div class="tiny-slide text-center">
                        <div class="cursor-e-resize">
                            ...
                            <div class="text-center mt-5">
                                <img src="frontend/assets/images/client/06.jpg" class="size-14 rounded-full shadow-md mx-auto" alt="">
                                <h6 class="mt-2 font-semibold">Cristino Murfi</h6>
                                <span class="text-slate-400 text-sm">Manager</span>
                            </div>
                        </div>
